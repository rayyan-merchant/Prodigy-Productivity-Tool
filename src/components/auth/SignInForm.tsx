        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
            ...
            <div className="flex justify-end">
              <button type="button" className="text-sm text-[#b4232a] hover:underline" onClick={() => setShowResetDialog(true)}>
                Forgot password?
              </button>
            </div>
          ...
          <Form {...resetForm}>
            <form onSubmit={resetForm.handleSubmit(onResetSubmit)} className="space-y-4">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="Enter your email address" type="email" disabled={isResetting} {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <DialogFooter>
                ...
                <Button type="submit" disabled={isResetting} className="bg-brand text-white hover:bg-brand/90">
